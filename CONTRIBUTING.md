# Contributing to minibase-create-plugin

:sparkles: Thanks for your contribution in advance! :tada:

First and foremost, thank you! We appreciate that you want to contribute to `minibase-create-plugin`, your time is valuable, and your contributions mean a lot to us.
...
1. **version**: what version of `minibase-create-plugin` were you using when you experienced the bug?
